...
function App() {
  ...
  const [listaTarefas, setListaTarefas] = useState([
    ...
    { id: 4, descricao:  "Espécie: Dinossauro\nRaça: Tyrannosaurus rex \nÚltima vez visto: época da Pedra\nAnimal Perdido ou Procura-se: Perdido", imagem:"https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcQwrgu2bbBfTF31DZgtQwLEtggCyaeDCubs0zsWdUVzHPrK30tG"},
  ]);
